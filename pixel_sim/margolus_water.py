    ...
    for i, j in canvas:
        if (i + i_offset) % 2 == 0 and (j + j_offset) % 2 == 0:
            ...
            if a0 == 0 and c0 == 1 and j != 0:
                ...
                c1 = 0
                b1 = 1
            elif a0 == 1 and b0 == 0 and d0 == 0:
                a1 = 0
                b1 = 1
            elif b0 == 1 and a0 == 0 and c0 == 0:
                b1 = 0
                a1 = 1
            elif a0 == 1 and b0 == 1 and c0 == 0 and d0 == 1:
                d1 = 0
                c1 = 1
            elif a0 == 1 and b0 == 1 and d0 == 0 and c0 == 1:
                c1 = 0
                d1 = 1
...
while window.running:
    if physics_running:
        for _ in range(n_ticks_per_frame):
            i_offset = offset_cycle[cycle_index][np.random.randint(0, 2)]
            j_offset = offset_cycle[cycle_index][np.random.randint(0, 2)]
